        ...
        <section className="tradex-pt-[60px] md:tradex-pt-[120px] tradex-relative tradex-z-10">
          <div className="tradex-container tradex-space-y-6 md:tradex-space-y-10">
            <div className=" tradex-flex tradex-justify-between tradex-items-center">
              <h3 className=" tradex-text-[24px] tradex-leading-[32px] md:tradex-text-[32px] md:tradex-leading-[48px] xl:tradex-text-[48px] xl:tradex-leading-[60px] !tradex-text-title tradex-font-medium tradex-font-nunito">
                {landing?.market_trend_title || t("Crypto Market Trend")}
              </h3>
              <Link href={`/markets`}>
                <a className=" tradex-px-3 tradex-py-2 md:tradex-py-4 md:tradex-px-6 tradex-flex tradex-gap-2 tradex-items-center tradex-text-xs md:tradex-text-base md:tradex-leading-6 tradex-font-medium !tradex-text-white tradex-rounded-full tradex-bg-darkBlue">
                  <span>{t(`See More`)}</span>
                  <span>
                    <FaArrowRight className=" tradex-w-4 md:tradex-w-[12px] ml-2" />
                  </span>
                </a>
              </Link>
            </div>
            ...
            <div className=" tradex-grid tradex-grid-cols-1 xl:tradex-grid-cols-3 tradex-gap-6 tradex-min-h-[600px]">
              <div className=" xl:tradex-col-span-2 tradex-border tradex-border-background-primary tradex-h-full tradex-pt-6  tradex-pb-4 tradex-space-y-6">
                <div className="tradex-pb-4 tradex-border-b tradex-border-background-primary">
                  <h4 className=" tradex-text-sm md:tradex-text-2xl md:tradex-leading-[30px] !tradex-text-title tradex-font-medium tradex-px-5">
                    {t(`Core Assets`)}
                  </h4>
                </div>
                <div className="tradex-max-h-[600px] tradex-overflow-y-auto tradex-overflow-x-auto">
                  {localAssetCoinPairs?.length > 0 ? (
                    <table className=" tradex-w-full tradex-border-separate tradex-border-spacing-y-2 tradex tradex-px-5">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        {localAssetCoinPairs?.map((item: any, index: any) => (
                          <tr key={item?.id} className="tradex-group">
                            <td
                              className={` ${
                                index + 1 != localAssetCoinPairs?.length &&
                                "tradex-border-b"
                              }  tradex-border-background-primary  tradex-py-3 tradex-px-2 tradex-text-nowrap`}
                            >
                            ...
                            <td
                              className={`${
                                index + 1 != localAssetCoinPairs?.length &&
                                "tradex-border-b"
                              }  tradex-border-background-primary tradex-py-3 tradex-px-2 tradex-text-nowrap tradex-text-center`}
                            >
                              <p className="tradex-text-base tradex-font-medium !tradex-text-title">
                                $
                                {formatCurrency(
                            ...
                            >
                              ...
                              >
                                <a className="tradex-py-3 tradex-px-6 tradex-border-none tradex-border tradex-border-darkBlue tradex-rounded-full group-hover:tradex-bg-darkBlue group-hover:!tradex-text-white !tradex-text-title tradex-bg-transparent tradex-text-sm tradex-leading-[18px]">
                                  {t(`Trade`)}
                                </a>
                              </Link>
                            </td>
                    ...
                    <p className="tradex-text-lg tradex-font-medium  tradex-min-h-[550px] tradex-flex tradex-justify-center tradex-items-center">
                      {t(`No Item Found`)}
                    </p>
                  )}
                </div>
              </div>
              <div className=" md:tradex-grid xl:tradex-block tradex-grid-cols-2 xl:tradex-grid-cols-1 tradex-border tradex-border-background-primary tradex-border-none tradex-h-full tradex-pt-6 tradex-px-4 tradex-pb-4 xl:tradex-space-y-4">
                <div>
                  <div className="tradex-pb-4 tradex-border-b tradex-border-background-primary">
                  ...
                  <div className=" tradex-max-h-[250px] tradex-overflow-y-auto tradex-overflow-x-auto">
                    {localHourlyCoinPairs?.length > 0 ? (
                      ...
                      <p className="tradex-text-lg tradex-font-medium  tradex-min-h-[200px] tradex-flex tradex-justify-center tradex-items-center">
                        {t(`No Item Found`)}
                      </p>
                    )}
                  </div>
