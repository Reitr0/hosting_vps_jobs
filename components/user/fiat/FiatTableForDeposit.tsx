        ...
        <table className="tradex-w-full tradex-border-separate tradex-border-spacing-y-2">
          ...
          <tbody>
            {data?.map((item: any, index: any) => (
              ...
              >
                <td className="tradex-border-b tradex-pr-4 last:tradex-pr-0 tradex-min-w-[80px] tradex-h-11  tradex-max-w-[200px]  tradex-text-sm   tradex-items-center group-hover:tradex-border-b-0 tradex-border-background-primary  tradex-py-3 tradex-text-nowrap tradex-text-ellipsis tradex-min-h-11">
                ...
                <td className="tradex-border-b tradex-pr-4 last:tradex-pr-0 tradex-min-w-[80px] tradex-h-11  tradex-max-w-[200px]  tradex-text-sm   tradex-items-center group-hover:tradex-border-b-0 tradex-border-background-primary  tradex-py-3 tradex-text-nowrap tradex-text-ellipsis tradex-min-h-11 cursor-pointer">
                  {item.bank_recipt ? (
                    <span
                      onClick={() => {
                        setIsModalOpen(true);
