  ...
  return (
    <>
      {customPageData && copyright_text && (
        <footer
          className={`tradex-bg-background-white tradex-space-y-[80px] tradex-py-[44px] `}
        >
            ...
            <div className="tradex-grid xl:tradex-grid-cols-12 tradex-gap-10">
              <div className="xl:tradex-col-span-3 tradex-space-y-20">
                ...
                <div className="tradex-space-y-6">
                  <div className="tradex-flex tradex-items-center tradex-gap-2">
                    <h4 className="tradex-text-xl tradex-leading-[26px] !tradex-text-black tradex-font-bold">
              ...
              <div className="xl:tradex-col-span-9 tradex-grid md:tradex-grid-cols-2 xl:tradex-grid-cols-4 tradex-gap-5 lg:tradex-gap-10">
                ...
                <div className="tradex-space-y-3 lg:tradex-space-y-10">
                  ...
                  <ul className="tradex-flex tradex-flex-col tradex-gap-y-4">
                    {parseInt(settings?.blog_news_module) === 1 && (
                      <li>
                        <Link href={"/blog"}>
                          <a className="tradex-text-base !tradex-text-black tradex-font-medium">
                            {t("Blog")}
                          </a>
                        </Link>
                      </li>
                    ...
                    {parseInt(settings?.knowledgebase_support_module) === 1 && (
                      <li>
                        <Link href={isLoggedIn ? "/support" : "/signin"}>
                          <a className="tradex-text-base !tradex-text-black tradex-font-medium">
                            {t("Support")}
                          </a>
                        </Link>
                ...
                <div className="tradex-space-y-3 lg:tradex-space-y-10">
                  ...
                  <ul className="tradex-flex tradex-flex-col tradex-gap-y-4">
                    {customPageData?.links?.map((item: any, index: any) =>
                      item.type === 1 ? (
                        <li key={index}>
                          {item.page_type === CUSTOM_PAGE_LINK_PAGE ? (
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="tradex-text-base !tradex-text-black tradex-font-medium"
                            >
                              {item.title}
                            </a>
                          )}
          ...
          <p className="tradex-text-center tradex-text-sm tradex-font-medium !tradex-text-black tradex-mb-8">
            {customPageData.copyright_text}
          </p>
        </footer>
      )}
