        ...
        <div className="cp-user-top-bar-right">
          <div>
            <ul>
              ...
              <li className="ml-10 mr-10 hm-notify" id="notification_item">
                <div className="btn-group profile-dropdown">
                  <button
                    type="button"
                    className="ml-0 bg-transparent btn dropdown-toggle"
                ...
                <div className="btn-group dropdown">
                  ...
                  <div className="dropdown-menu notification-list dropdown-menu-right">
                    ...
                    <div className="scroll-wrapper scrollbar-inner position-relative">
                      <ul className="h-auto mb-0 mr-0 scrollbar-inner scroll-content max-h-0"></ul>
              ...
              <nav className="main-menu">
                <ul>
                  <li className="hm-notify">
                    ...
                    <ul className="right-0 left-auto dropdown-menu-main">
