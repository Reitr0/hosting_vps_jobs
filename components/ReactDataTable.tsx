                        ...
                        {row.cells.map((cell, key) => (
                          ...
                          >
                            <div
                              ...
                              } !tradex-pr-4 last:tradex-pr-0  tradex-text-sm  tradex-flex tradex-items-center tradex-h-full group-hover:tradex-border-b-0 tradex-border-background-primary  tradex-py-3 tradex-text-nowrap tradex-text-ellipsis tradex-min-h-11`}
                            >
                              {cell.render("Cell")}
                            </div>
                          </td>
