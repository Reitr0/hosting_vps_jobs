  ...
  return (
    <div>
      {parseInt(landing?.landing_first_section_status) === 1 && (
        <section className="tradex-bg-background-white tradex-min-h-[660px] tradex-relative !tradex-font-nunito">
          ...
          {/* <img
            ...
            alt=""
          /> */}
          <div className=" tradex-container tradex-pt-8 md:tradex-pt-20 tradex-pb-[140px] tradex-flex tradex-flex-col lg:tradex-flex-row tradex-items-center tradex-relative tradex-z-10 tradex-gap-6 md:tradex-gap-0">
            <div className="xl:tradex-min-w-[700px] tradex-max-w-[700px] tradex-space-y-8">
              <div className=" tradex-space-y-2 md:tradex-space-y-6">
                <h1 className=" tradex-text-[32px] tradex-leading-[42px] !tradex-font-nunito md:tradex-text-[48px] md:tradex-leading-[64px] xl:tradex-text-5xl xl:tradex-leading-[64px] !tradex-font-semibold">
                  {landing_title ? (
                    <TextAnimation text={landing_title} />
                  ) : (
                    <>
                      <TextAnimation text={`Make Easy Your`} />
                      <span className=" !tradex-text-darkBlue">
                        {t(`Buy Sell & Trade `)}
                      </span>
                ...
                <p className="tradex-max-w-[450px] tradex-text-xs tradex-leading-[18px] md:tradex-text-xl md:tradex-leading-7 ">
                  {landing_description ||
              ...
              {!loggedin && (
                ...
                >
                  <a className="tradex-w-fit tradex-px-6 tradex-py-3 md:tradex-px-8 md:tradex-py-5 tradex-bg-darkBlue tradex-flex tradex-justify-center tradex-gap-2 tradex-items-center tradex-rounded-full !tradex-text-background-main hover:tradex-bg-darkBlue/90 hover:!tradex-text-white">
