                        ...
                        <Form className="tradex-space-y-6">
                          <div className="tradex-space-y-2">
                            <div className=" tradex-space-y-6">
                              <div className="tradex-relative">
                                <Field
                                  ...
                                  name="email"
                                  id="email"
                                  className={`tradex-block tradex-px-2.5 tradex-pb-2.5 tradex-pt-4 tradex-w-full tradex-text-sm  tradex-bg-transparent tradex-rounded-lg tradex-border-1 tradex-border-background-primary tradex-appearance-none focus:tradex-outline-0 focus:tradex-ring-0 tradex-peer ${
                                ...
                                <label
                                  htmlFor="email"
                                  className="tradex-absolute tradex-text-sm  tradex-duration-300 tradex-transform -tradex-translate-y-4 tradex-scale-75 tradex-top-2 tradex-z-10 tradex-origin-[0] tradex-bg-background-main tradex-px-2 peer-focus:tradex-px-2   peer-placeholder-shown:tradex-scale-100 peer-placeholder-shown:-tradex-translate-y-1/2 peer-placeholder-shown:tradex-top-1/2 peer-focus:tradex-top-2 peer-focus:tradex-scale-75 peer-focus:-tradex-translate-y-4 rtl:peer-focus:tradex-translate-x-1/4 rtl:tradex-peer-focus:left-auto tradex-start-1"
                                >
                                  {t(`Email`)}
                                </label>
                              </div>
                            ...
                            <Link href="/forgot-password">
                              <a className=" tradex-text-base tradex-font-semibold  !tradex-underline tradex-block">
                                {t("Forgot Password?")}
                              </a>
                            </Link>
                          </div>
