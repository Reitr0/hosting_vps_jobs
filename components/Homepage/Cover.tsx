          ...
          <div className=" tradex-container tradex-pt-8 md:tradex-pt-20 tradex-pb-[140px] tradex-flex tradex-flex-col lg:tradex-flex-row tradex-items-center tradex-relative tradex-z-10 tradex-gap-6 md:tradex-gap-0">
            <div className="xl:tradex-min-w-[700px] tradex-max-w-[700px] tradex-space-y-8">
              ...
              {!loggedin && (
                ...
                >
                  <a className="tradex-w-fit tradex-px-6 tradex-py-3 md:tradex-px-8 md:tradex-py-5 tradex-bg-darkBlue tradex-flex tradex-justify-center tradex-gap-2 tradex-items-center tradex-rounded-full !tradex-text-white hover:tradex-bg-darkBlue/90 hover:!tradex-text-white">
