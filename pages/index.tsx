...
import AdsSectionLeft from "components/Homepage/AdsSectionLeft";
import JoinCommunity from "components/Homepage/JoinCommunity";
import MassAdoption from "components/MassAdoption";
import AdsSectionRight from "components/Homepage/AdsSectionRight";
...
const Home: NextPage = ({
  ...
  return (
    <SEO seoData={customSettings}>
      <div>
        <div className="tradex-font-nunito">
          {loggedin ? (
          ...
          <>
            ...
            <AdsSectionRight landing={landing} image="/adsl-1.png" title="Withdraw your digital assets seamlessly" description="Access your diverse crypto holdings instantly and withdraw them seamlessly worldwide with our Mastercard." />

            <AdsSectionLeft landing={landing} image="/adsl-2.png" title="Diversified trading options" description="A wide range of trading products can help you explore and play with digital assets, including spot, leverage, futures, stock, forex, and other trading varieties." />
            
            <AdsSectionRight landing={landing} image="/adsl-3.png" title="Top security risk management system" description="Leading-edge security technology and 24/7 platform monitoring guarantee that your assets are safeguarded in all capacities." />
