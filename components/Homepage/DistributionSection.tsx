        ...
        parseInt(landing?.download_link_display_type) === 1 && (
          <section className="tradex-relative tradex-z-10 tradex-pt-[60px] md:tradex-pt-[120px]">
            <div className=" tradex-container">
              <div className=" tradex-flex tradex-flex-col lg:tradex-flex-row  tradex-gap-10 tradex-items-center">
                <div className="lg:tradex-max-w-[500px] xl:tradex-max-w-[695px] xl:tradex-min-w-[695px] tradex-space-y-6">
                  <div className=" tradex-space-y-4 md:tradex-space-y-10">
                    <div className=" tradex-space-y-2 md:tradex-space-y-4">
                      <h3 className="tradex-max-w-[600px] !tradex-font-nunito tradex-text-[24px] tradex-leading-[32px]  md:tradex-text-[32px]  xl:tradex-leading-[60px] !tradex-text-title tradex-font-bold">
                        {landing?.trade_anywhere_title ||
                          "Tradexpro: Trade With Anytime Anywhere"}
                      </h3>
                    </div>
                    <div className="tradex-flex tradex-items-center tradex-bg-darkBlue/10 tradex-w-fit tradex-p-8 tradex-px-9 tradex-rounded-2xl">
                      {/* <PlayStoreQr storeUrl={landing?.google_store_link} /> */}
                      <img
                        src="/qr.jpeg"
                        alt=""
                        className="tradex-max-w-[100px] tradex-max-h-[100px] tradex-w-full tradex-h-full tradex-object-cover tradex-object-center tradex-rounded-lg"
                      />
                      <div className=" tradex-space-y-3 ml-4">
                        <p className=" tradex-text-base tradex-leading-6 ">
                          Download SolXChange
                        </p>
                  ...
                  <div className=" tradex-flex tradex-items-center tradex-flex-wrap tradex-gap-5">
                    <a
                      href={landing?.apple_store_link}
                      target="_blank"
                      rel="noreferrer"
                    >
                      <div className="tradex-min-w-[88px] tradex-min-h-[80px] tradex-bg-darkBlue/10 tradex-rounded-xl tradex-border tradex-border-background-card tradex-flex tradex-flex-col tradex-items-center tradex-justify-center tradex-gap-y-3 tradex-transition-all tradex-duration-[260ms] tradex-ease-[cubic-bezier(0.42,0,0.58,1)] tradex-delay-[0s] hover:tradex-shadow-[2px_2px_50px_0px_#0000000F]">
