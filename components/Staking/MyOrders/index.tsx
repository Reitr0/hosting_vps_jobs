                ...
                {history.length > 0 &&
                  history?.map((item: any, index: any) => (
                    <tr
                      ...
                      key={index}
                    >
                      <td className="tradex-pr-4 last:tradex-pr-0 tradex-min-w-[100px] tradex-h-11  tradex-max-w-[200px] tradex-text-sm  group-hover:tradex-border-b-0 tradex-border-background-primary  tradex-py-3 tradex-text-nowrap tradex-text-ellipsis">
                      ...
                      STAKING_INVESTMENT_STATUS_RUNNING ? (
                        <td
                          ...
                          className=" tradex-text-yellow-600 tradex-pr-4 last:tradex-pr-0 tradex-min-w-[100px] tradex-h-11  tradex-max-w-[200px] tradex-text-sm  group-hover:tradex-border-b-0 tradex-border-background-primary  tradex-py-3 tradex-text-nowrap tradex-text-ellipsis"
                        >
                          {t(`Cancel`)}
                        </td>
                      ) : parseInt(item?.status) ===
                        STAKING_INVESTMENT_STATUS_CANCELED ? (
                        <td className=" tradex-text-red-600 tradex-pr-4 last:tradex-pr-0 tradex-min-w-[100px] tradex-h-11  tradex-max-w-[200px] tradex-text-sm  group-hover:tradex-border-b-0 tradex-border-background-primary  tradex-py-3 tradex-text-nowrap tradex-text-ellipsis">
                          {t(`Cancelled`)}
                        </td>
                      ) : parseInt(item?.status) ===
                        STAKING_INVESTMENT_STATUS_PAID ? (
                        <td className=" tradex-text-green-600 tradex-pr-4 last:tradex-pr-0 tradex-min-w-[100px] tradex-h-11  tradex-max-w-[200px] tradex-text-sm  group-hover:tradex-border-b-0 tradex-border-background-primary  tradex-py-3 tradex-text-nowrap tradex-text-ellipsis">
                          {t(`Paid`)}
                        </td>
                      ) : (
                        ""
                      ...
                      <td
                        ...
                        data-toggle="modal"
                        className="tradex-pr-4 last:tradex-pr-0 tradex-min-w-[100px] tradex-h-11  tradex-max-w-[200px] tradex-text-sm  group-hover:tradex-border-b-0 tradex-border-background-primary  tradex-py-3 tradex-text-nowrap tradex-text-ellipsis"
                        onClick={() => {
                          setModalData(item);
                        }}
                      >
